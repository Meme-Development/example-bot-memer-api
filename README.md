...
## MEMER API IS A FREE TO USE API WHICH HELPS IN IMAGE MANIPULATION ONLY SOME OF THE COMMANDS IN MEMER API ARE USED IN THIS BOT.YOU CAN MAKE MORE COMMANDS BY USING MEMER API
